...
#file_list = [70,4,27,38,56,76,80,45,72,42,68,33,9,26,17,28,37,69,79,29,53]
#file_list = [10,19,22,16,28,20,29,12,15,9,11,24,25,26,13]
file_list = [1, 2]

for i, item in enumerate(file_list):
    file_list[i] = "weights_b25_150_"+str(item)

model_complex_builder(file_list, '3')
